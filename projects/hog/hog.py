...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_score=0
    for i in range(1,11):
        run_experiment=make_averaged(roll_dice,trials_count)
        score=run_experiment(i,dice)
        if score>max_score:
            max_score=score
            min_roll=i
    return min_roll
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    after_piggy=picky_piggy(opponent_score)+score
    if after_piggy==opponent_score:
        return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if hog_pile_strategy(score,opponent_score,cutoff=8,num_rolls=6)==0:
        return 0
    elif picky_piggy_strategy(score,opponent_score,cutoff=8,num_rolls=6)==0:
        return 0
    else:
        if score>=90:
            return 2
