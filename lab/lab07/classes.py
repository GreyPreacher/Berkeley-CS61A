...
class AICard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        800
        """
        if opponent_card.defense > opponent_card.attack:
...
#I donot figure this problem out so I donot implement the TACard
class TACard(Card):
    cardtype = 'TA'
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        300
        """
        temp = opponent_card.defense
        opponent_card.defense = opponent_card.attack
        opponent_card.attack = temp
