...
def distance(city_a, city_b):
    ...
    5.0
    """
    x_dis=get_lat(city_a)-get_lat(city_b)
    y_dis=get_lon(city_a)-get_lon(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    the_city=make_city("the_one",lat,lon)
    if distance(the_city,city_a)<distance(the_city,city_b):
